    ...
    <div class="thank-you-container">
      ...
      >
        <div class="container d-flex justify-content-center align-items-center">
          <div
            class="ticket position-relative d-flex flex-column justify-content-around"
          >
        ...
        <!-- <div class="qr" style="margin-left: 725px; margin-bottom: 2000px">
          <qr />
        </div> -->
      </div>
...
//   data = ticketstore.getticket
  ...
  .ticket {
    ...
    background-image: url("../../assets/dataa.jpg");
  }
